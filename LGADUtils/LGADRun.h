...
class LGADRun : public LGADBase {

public:

    LGADRun();                // Default constructor
    LGADRun(LGADBase* rBase); // Constructor from LGADBase object
    ~LGADRun();               // Destructor
...
private:
    ...
    bool InitNtuple(std::vector<TTree*>& inputrees, std::vector<TFile*>& inputfiles);
    ...
    std::vector<unsigned int> m_filelvl;
    std::vector<unsigned int> m_FFTShape;
    ...
    TTree* m_OutTree;
    TTree* m_OutChTree;
    TTree* m_OutShapeTree;
    TTree* m_OutTimeResTree;
    ...
    std::vector<TBranch*> b_triggTime_out;   //!
    std::vector<TBranch*> b_Scope_out;   //!
    TBranch* b_trigtime_out;   //!
    TBranch* b_EvnNo_out;   //!
